...
apk add figlet pv ncurses-utils binutils coreutils wget git zsh termux-api -y &> /dev/null;
termux-wake-lock;
if [ -e $PREFIX/share/figlet/Remo773.flf ]; then
	echo -e "\e[1;34m[*] \033[32mRemo773.flf figlet font is present\033[0m";
	sleep 4
else
wget https://raw.githubusercontent.com/Biangkerok32/AlpineHeader/master/Remo773.flf &> /dev/null;
sleep 3
...
echo -e '\033[32m## AIMod http://aimod.blogspot.com ## \033[0m';
echo -e '\e[0;35m+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+\e[00m';
echo "";
...
if [ "$PROC32" = "y" ]; then
	...
	wget https://raw.githubusercontent.com/Biangkerok32/AlpineHeader/master/Alpine.txt &> /dev/null ;
...
wget https://raw.githubusercontent.com/Biangkerok32/AlpineHeader/master/.remo773.zsh-theme &> /dev/null
sed -e "s/\Remo773/$PROC/g" .remo773.zsh-theme > $HOME/.oh-my-zsh/themes/xiong-chiamiov-plus.zsh-theme
fi
source ~/.zshrc
else
